...
@section('content')
    <div class="rose-panel" style="max-width:550px;">
        <h2 class="rose-panel-title">Tambah Produk Baru</h2>

        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="rose-form">
            @csrf
            ...
            <label style="display:flex; align-items:center; gap:8px; margin-bottom:20px;">
                <input type="checkbox" name="is_best_seller" value="1" @checked(old('is_best_seller')) style="width:auto; margin:0;">
            ...
            <button type="submit" class="rose-btn-pink">Simpan Produk</button>
        </form>
    </div>
